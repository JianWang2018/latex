...
\degreeyear{2017}
\defensedate{July 18 ,   2017}

%\subject{My Topic}
%\keywords{keyterm1; keyterm2; keyterm3; ...}

\committeeperson{Jinfeng Zhang}{Professor Co-Directing Dissertation}

\committeeperson{Giray $\ddot{O}$kten}{Professor Co-Directing Dissertation}
\committeeperson{Alec Kercheval}{Committee Member}
\committeeperson{Washington Mio}{Committee Member}
\committeeperson{Capstick Simon}{University Representative}
\clubpenalty=9999
\widowpenalty=9999
...
\renewcommand{\listofalgorithms}{%
    \FSU@lofsomething{List of Algorithms}{loa}}
\makeatother
...
At the same time, I would also like to thank my colleagues and friends at department: Yang Liu,   He Huang,   Jinghua Yan,   Bo Zhao,   Jian Geng,   Ming Zhu,   Wanwan Huang,   Yuan Zhang,   Wen Huang,   Yaning Liu,  Qiuping Xu,   Guifang Zhou,   Pierre Garreau,   Ahmed Islim,   Dawna Jones,   Linlin Xu,   Yuying Tzeng,  	Szu-Yu Pai,   Nguyet Nguyen,   Dong Sun,   Daozhi Han,   Yuanda Chen,   Chun-Yuan Chiu,   Chenchen Zhou,  	Yao Dai,   Chaoxu Pei,   Fangxi Gu,   Zailei Cheng,   Jian Li,  	Xinru Yuan,   Haixu Wang,  	Wei Meng and Qi Si for their help,   cooperation and meaningful suggestions to my research.\\
