...
\usepackage{enumitem}
\usepackage{xcolor}
\usepackage[colorlinks=false,% hyperlinks will be black
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
 \huge{\textbf{Jian Wang}}\\
 \faGithub\ \href{https://github.com/wangjian790/}{\color{blue}{https://github.com/wangjian790/}} & \faEnvelope\ \href{mailto:jw2018jobs@gmail.com}{\color{blue}{jw2018jobs@gmail.com}}\\
  \faUser \ \href{http://www.math.fsu.edu/~jwang/}{\color{blue}{http://www.math.fsu.edu/\textasciitilde jwang/} }&\faPhone \hspace{1cm} \
       \color{blue}{+1-850-443-5826} \\
\end{tabular*}
%--------------Objective---------------
\section{ OBJECTIVE}
