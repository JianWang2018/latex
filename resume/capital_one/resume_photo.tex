...
\large{
  \begin{tabu}{l r }
    \scshape{\huge{Jian Wang}} & \hspace{1.5cm}  \pbar{C++}{0.95} \\
     \email {wangjian790@gmail.com} &  \hspace{1.5cm} \pbar{Java}{0.9} \\
     \phone{(+1) 850-443-5826} & \hspace{1.5cm}\pbar{Python}{0.9} \\
     \faUser \ \changeurlcolor{blue}\href{https://wangjian790.github.io/jianwang.github.io/}{https://wangjian790.github.io/jianwang.github.io/} &   \hspace{1.5cm}\pbar{Linux}{0.8} \\
     \faGithub\ \changeurlcolor{blue}\href{https://github.com/wangjian790/}{https://github.com/wangjian790/} & \hspace{1.5cm}  \pbar{Latex}{0.8}\\
     \faLinkedin\ \changeurlcolor{blue}\href{https://www.linkedin.com/in/jian-wang-9b476617/}{https://www.linkedin.com/in/jian-wang-9b476617/} &  \hspace{1.5cm} \pbar{Matlab}{0.8}
...
\section{\faThumbsOUp\ Strength and objective:}\large 
 Financial math Ph.D. with three years actuarial and data analysis working experience in insurance companies. Strong C++, Java and Python skills. Proficient in machine learning, mathematics, and programming. Currently seeking data scientist jobs in financial companies. 
