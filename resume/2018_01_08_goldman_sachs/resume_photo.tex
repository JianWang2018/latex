...
\section{\faThumbsOUp\ Strength and objective:}\large 
 Past quantitative working experience in insurance companies. Strong C++, Java, Python skills. Proficient in programming, machine learning, financial math and big data.  Financial math Ph.D. and currently seeking full stack coding jobs.
...
\section{\faShirtsinbulk \ Certificates}\large 
 Deep learning.ai certificate(three courses); Machine learning certificate(four courses); Lynda C++ Essential Training certificate; Lynda Become a C++ Developer certificate.
