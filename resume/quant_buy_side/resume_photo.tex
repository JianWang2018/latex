...
\large{
  \begin{tabu}{l r }
    \scshape{\huge{Jian Wang}} & \hspace{2cm}  \pbar{C++}{0.95} \\
     \email{jw2018jobs@gmail.com} &  \hspace{2cm} \pbar{Java}{0.9} \\
...
\section{\faThumbsOUp\ Strength and objective:}\large 
 Financial math Ph.D. with three years quantitative and research working experience in insurance and securities companies. Strong C++, Java and Python skills. Proficient in machine learning, mathematics, and programming. Currently seeking market risk jobs. 
